...
class AppTheme {
  ...
  static Color _lightPrimaryVariantColor = Colors.deepOrange;
  static const Color _lightSecondaryColor = Colors.grey;
  static const Color _lightOnPrimaryColor = Colors.black;
  static Color _lightPrimaryIconThemeColor = Colors.deepOrange;
  static const Color _lightButtonTextColor = Colors.white;
  static const Color _lightButtonColor = Colors.yellow;
  static Color _lightButtonSplashColor = Colors.deepOrange;
