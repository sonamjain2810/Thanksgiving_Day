...
import 'package:thanksgiving_day/data/Messages.dart';
import 'package:app_tracking_transparency/app_tracking_transparency.dart';
import 'package:cached_network_image/cached_network_image.dart';
import 'package:facebook_app_events/facebook_app_events.dart';
import 'package:flutter/material.dart';
import 'package:flutter/services.dart';
import 'package:thanksgiving_day/StatusList.dart';
import 'package:thanksgiving_day/widgets/CustomFBTextWidget.dart';
import 'package:thanksgiving_day/widgets/CustomFeatureCard.dart';
import 'package:thanksgiving_day/widgets/CustomFullCard.dart';
...
class _HomePageState extends State<HomePage> {
  ...
  late BannerAd bannerAd1, bannerAd2, bannerAd3, bannerAd4;
                            ...
                            child: InkWell(
                              child: Row(
                                ...
                                children: <Widget>[
                                  CustomFeatureCard(
                                    size: size,
                                    imageUrl: Gifs.gifs_path[23],
                                  ),
                                  CustomFeatureCard(
                                    size: size,
                                    imageUrl: Gifs.gifs_path[27],
                                  ),
                                  CustomFeatureCard(
                                    size: size,
                                    imageUrl: Gifs.gifs_path[29],
                                  ),
                                  CustomFeatureCard(
                                    size: size,
                                    imageUrl: Gifs.gifs_path[32],
                                  ),
                                ],
                              ),
                              onTap: () {
